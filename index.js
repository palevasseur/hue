...
// https://github.com/quibusus/node-xiaomi-smart-home
  ...
  action(step) {
    ...
    switch(step) {
      case 1:
        ...
        api.setLightState(this.lightId, newState).then(res => console.log(`Light ${this.lightId} ${this.lightState}, success=: ${res}`));
        break;
      case 2:
